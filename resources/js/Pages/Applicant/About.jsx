            ...
            <div className="user-container">
                ...
                <div className="main-content">
                    ...
                    <h1 className="company-name">
                        Welcome To{" "}
                        <strong className="text-5xl">{company_name}</strong>
                    </h1>
                    ...
                    <div className="main-section">
                        <div className="body-section">
                            <h1 className="header-one">
                                Let's surf for your desired products.
                            </h1>
                            <p className="header-two">
                                Reach out today and start shopping !!!
                            </p>
                            <div className="button-section">
                                <Link href="/applicant/contact">
                                    <PrimaryButton className="contact-btn">
                                        Contact
                                    </PrimaryButton>
                                </Link>
                                <Link href="/applicant/authdash">
                                    <PrimaryButton className="product-btn">
                                        Product
                                    </PrimaryButton>
                                </Link>
                            </div>
                    ...
                    <div className="banner-section">
                        ...
                        <div className="service-section">
                            ...
                            <ul>
                                <li>
                                    <Link className="service-link">
                                        <FaTruckMoving className="icons" /> Home
                                        Delivery
                                    </Link>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <Link className="service-link">
                                        <FaHeadset className="icons" /> Customer
                                        Service 24/7
                                    </Link>
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li>
                                    <Link className="service-link">
                                        <FaBoxOpen className="icons" /> Post
                                        Sales Services
                                    </Link>
                                </li>
                            </ul>
                    ...
                    <div className="features-section">
                        <div className="feature-cards">
                            <h2>Feature One :</h2>
                            <p>
                                Boost your productivity with our top-notch
                                tools.
                            </p>
                        </div>
                        <div className="feature-cards">
